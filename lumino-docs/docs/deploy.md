...
# Despliegue
!!! Example inline end "Ejemplo Servidores"
    Microsoft Azure y AWS[^1] son plataformas de computación en la nube que proporcionan infraestructura y servicios bajo demanda para desplegar y gestionar aplicaciones sin necesidad de mantener servidores físicos propios.

    === "Servicios"
        - Máquinas virtuales y servicios gestionados para ejecutar aplicaciones web.
        - Bases de datos escalables y seguras.
        - Herramientas de monitorización, seguridad y copias de seguridad.
        - Alta disponibilidad y posibilidad de escalar según la carga.

    === "Funcionalidades"
        - Escalabilidad, adaptando los recursos al crecimiento de usuarios.
        - Alta disponibilidad, reduciendo caídas del servicio.
        - Seguridad, mediante servicios integrados de control y protección.
        - Mantenimiento simplificado, al delegar la gestión de la infraestructura física.


Lumino está concebido para desplegarse en un **servidor en la nube**, lo que permite garantizar disponibilidad, escalabilidad y un entorno de ejecución controlado. Este despliegue se apoya en una estrategia **CI[^2]/CD[^3]**, orientada a mantener altos estándares de calidad en cada versión del sistema.
